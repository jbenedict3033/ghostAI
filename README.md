...
That said, this project is still underway and will continue to get better over time.<br/><br/>
### Deliverables<br/>
The ghostAI folder contains four folders and two files.<br/><br/>
###### Folders
...
- _objects_       empty when downloaded, but holds object files when the associated makefile is used<br/><br/>
###### Files
